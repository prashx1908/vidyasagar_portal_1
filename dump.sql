...
CREATE TABLE IF NOT EXISTS "app_student" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "address" text NOT NULL, "gender" varchar(100) NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "admin_id" bigint NOT NULL UNIQUE REFERENCES "app_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "course_id_id" bigint NOT NULL REFERENCES "app_course" ("id") DEFERRABLE INITIALLY DEFERRED);
CREATE TABLE IF NOT EXISTS "app_staff" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "address" text NOT NULL, "gender" varchar(100) NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "admin_id" bigint NOT NULL UNIQUE REFERENCES "app_customuser" ("id") DEFERRABLE INITIALLY DEFERRED, "department" varchar(100) NOT NULL);
CREATE TABLE IF NOT EXISTS "app_customuser" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "password" varchar(128) NOT NULL, "last_login" datetime NULL, "is_superuser" bool NOT NULL, "username" varchar(150) NOT NULL UNIQUE, "first_name" varchar(150) NOT NULL, "last_name" varchar(150) NOT NULL, "email" varchar(254) NOT NULL, "is_staff" bool NOT NULL, "is_active" bool NOT NULL, "date_joined" datetime NOT NULL, "profile_pic" varchar(100) NULL, "student_details_link" varchar(200) NULL, "department" varchar(100) NULL, "user_type" varchar(50) NOT NULL);
