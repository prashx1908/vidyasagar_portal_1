...
urlpatterns = [
    ...
    path("Hod/Student/PermanentlyDelete/<int:student_id>", admin_views.permanent_delete_student, name='permanent_delete_student'),
    ...
    path("Hod/Students/View/Junior1", admin_views.view_students_junior1, name='hod_view_students_junior1'),
    path("Hod/Students/View/Junior2", admin_views.view_students_junior2, name='hod_view_students_junior2'),
    path("Hod/Students/View/Junior3", admin_views.view_students_junior3, name='hod_view_students_junior3'),
    path("Hod/Students/View/Middle1", admin_views.view_students_middle1, name='hod_view_students_middle1'),
    path("Hod/Students/View/Middle2", admin_views.view_students_middle2, name='hod_view_students_middle2'),
    path("Hod/Students/View/Middle3", admin_views.view_students_middle3, name='hod_view_students_middle3'),
    path("Hod/Students/View/Middle4", admin_views.view_students_middle4, name='hod_view_students_middle4'),
    path("Hod/Students/View/Middle5", admin_views.view_students_middle5, name='hod_view_students_middle5'),
