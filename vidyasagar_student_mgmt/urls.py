...
urlpatterns = [
                  ...
                  path("Hod/Staff/PermanentlyDelete/<int:staff_id>/", admin_views.permanent_delete_staff,
                  ...
                  path("Staff/View/Students/Junior1", staff_views.VIEW_STUDENTS_JUNIOR1,
                       name='staff_view_students_junior1'),
                  path("Staff/View/Students/Junior2", staff_views.VIEW_STUDENTS_JUNIOR2,
                       name='staff_view_students_junior2'),
                  path("Staff/View/Students/Junior3", staff_views.VIEW_STUDENTS_JUNIOR3,
                       name='staff_view_students_junior3'),
                  path("Staff/View/Students/Middle1", staff_views.VIEW_STUDENTS_MIDDLE1,
                       name='staff_view_students_middle1'),
                  path("Staff/View/Students/Middle2", staff_views.VIEW_STUDENTS_MIDDLE2,
                       name='staff_view_students_middle2'),
                  path("Staff/View/Students/Middle3", staff_views.VIEW_STUDENTS_MIDDLE3,
                       name='staff_view_students_middle3'),
                  path("Staff/View/Students/Middle4", staff_views.VIEW_STUDENTS_MIDDLE4,
                       name='staff_view_students_middle4'),
                  path("Staff/View/Students/Middle5", staff_views.VIEW_STUDENTS_MIDDLE5,
                       name='staff_view_students_middle5'),
                  ...
                  path('students/junior1/download/', admin_views.download_students_junior1,
                       name='download_students_junior1'),
                  path('students/junior2/download/', admin_views.download_students_junior2,
                       name='download_students_junior2'),
                  path('students/junior3/download/', admin_views.download_students_junior3,
                       name='download_students_junior3'),
                  path('students/middle1/download/', admin_views.download_students_middle1,
                       name='download_students_middle1'),
                  path('students/middle2/download/', admin_views.download_students_middle2,
                       name='download_students_middle2'),
                  path('students/middle3/download/', admin_views.download_students_middle3,
                       name='download_students_middle3'),
                  path('students/middle4/download/', admin_views.download_students_middle4,
                       name='download_students_middle4'),
                  path('students/middle5/download/', admin_views.download_students_middle5,
                       name='download_students_middle5'),
